...
public class PlayerWeaponController : MonoBehaviour
{
    ...
    public Transform weaponsParentSocket;
    ...
    {
        weaponsParentSocket.position = defaultWeaponPosition.position;
        ...
        for (int i = 0; i < weaponSlots.Length; i++)
        {
            ...
            {
                WeaponController weaponClone = Instantiate(p_weaponController, weaponsParentSocket);
